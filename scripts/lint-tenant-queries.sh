...
TENANT_TABLES="assets secrets audit_log memberships tenant_quotas pipeline_runs pipeline_steps pipeline_step_deps voice_presets image_styles characters character_refs character_loras character_voices narrator_voices series_storyboard_settings scenes scene_takes render_settings render_manifests render_manifest_segments render_segments renders library_settings"
