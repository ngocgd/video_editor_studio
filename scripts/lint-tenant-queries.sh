...
TENANT_TABLES="assets secrets audit_log memberships tenant_quotas pipeline_runs pipeline_steps pipeline_step_deps voice_presets image_styles characters character_refs character_loras character_voices narrator_voices series_storyboard_settings scenes scene_takes series story_bibles episodes episode_drafts episode_draft_revisions imports llm_settings draft_step_applications youtube_channels youtube_oauth_states render_settings render_manifests render_manifest_segments render_segments renders library_settings analytics_tracked_videos video_metrics_daily video_retention channel_metrics_daily analytics_sync_state analytics_reporting_jobs analytics_reporting_reports analytics_suggestions"
