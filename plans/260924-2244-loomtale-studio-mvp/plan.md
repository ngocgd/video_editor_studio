...
|---|---|---|---|---|---|
| 1 | [Repo scaffold, toolbox, CI, codegen, memory budget](phase-01-repo-scaffold-tooling-ci.md) | 14h | none | A | pending |
...
| 5 | [Frontend foundation and shared components](phase-05-frontend-foundation.md) | 18h | 2; step 7 needs 3 | C | pending |
