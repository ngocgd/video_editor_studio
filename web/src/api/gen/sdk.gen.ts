 ...
 */
export const testLlmSettings = <ThrowOnError extends boolean = false>(options?: Options<TestLlmSettingsData, ThrowOnError>): RequestResult<TestLlmSettingsResponses, unknown, ThrowOnError> => (options?.client ?? client).post<TestLlmSettingsResponses, unknown, ThrowOnError>({
